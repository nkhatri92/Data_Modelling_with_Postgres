...
def process_song_file(cur, filepath):
    ...
    * artist_data in artists table.
    ...
    artist_data = list(df[['song_id','artist_name','artist_location','artist_latitude', 'artist_longitude']].values[0])
...
def process_log_file(cur, filepath):
    ...
    * songplay_data in songplay table.
    ...
    keys_of_dict = column_labels
    values_of_dict = time_data 
    time_df = pd.DataFrame(dict(zip(keys_of_dict, values_of_dict)))
